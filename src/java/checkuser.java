    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            + "and clave = " + "'" + request.getParameter("inputPassword") + "'");
                ...
                out.println("No hay usuario que coincidad con la busqueda");                 
                out.println("<h1>Proyecto: " + request.getContextPath() + "</h1>");
                out.println("<h1>Usuario es: " + request.getParameter("inputEmail") + "</h1>"); //el usuario que yo ingrese en el sistema, me lo muestre del lado del backend.
